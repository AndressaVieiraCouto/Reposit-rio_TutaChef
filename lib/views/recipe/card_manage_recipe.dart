...
import 'package:tutachef_project/views/recipe/add_recipe_view.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: AddRecipeView(editRecipe: true),
          actions: <Widget>[
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).pop();
                AppCore().successDialog(context, '$type alterada com sucesso');
              },
              child: Text(
                action ?? 'Adicionar',
